...
const questions = [ // ✅ Added a valid variable name
  {
...
export default function FAQSection() { // ✅ Renamed component to avoid conflict
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="space-y-4">
        {questions.map((faq, index) => ( // ✅ Changed `Questionpage` to `questions`
