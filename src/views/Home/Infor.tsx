...
<>
<Navbar />
    <div className="  bg-[#272525] main font-sans bg-cover bg-center bg-blend-overlay" 
      style={{ backgroundImage: "url('/images/online-6817350_1280.jpg')" }}> 
        ...
        <h2 className="text-4xl font-bold text-white mt-4">Contact Us</h2>
            ...
            <div className=" text-white">
              ...
              <p className="text-lg font-semibold">1234 Divi St. #1000 San Francisco, </p>
  ...
  <button className="bg-yellow-500 text-black px-6 py-2 font-bold rounded-md hover:bg-yellow-600 transition">
    SUBMIT
       ...
       <section className='text-center px-6 py-10'>
        ...
        <p className='max-w-3xl mx-auto mt-4 text-gray-700 text-lg'>Lyndon Group specializes in finance, IT, governance, and risk management to help businesses succeed.</p>
        <button className='mt-6 bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600'>Read More</button>
      </section>
        {/* third sectionnn............................................ */}
